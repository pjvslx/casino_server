...
class AopClient {
	...
	public function sign($data, $signType = "RSA") {
		file_put_contents("d:/phpsign.txt", "data = $data.\n", FILE_APPEND);
	...
	*/
	...
	function verify($data, $sign, $rsaPublicKeyFilePath, $signType = 'RSA') {
		file_put_contents("d:/verify.txt", "key = $this->alipayrsaPublicKey\n", FILE_APPEND);
		file_put_contents("d:/verify.txt", "data = $data\n", FILE_APPEND);
		file_put_contents("d:/verify.txt", "sign = $sign\n", FILE_APPEND);
		if($this->checkEmpty($this->alipayPublicKey)){
			file_put_contents("d:/verify.txt", "1111111111\n", FILE_APPEND);
			$pubKey= $this->alipayrsaPublicKey;
			$res = "-----BEGIN PUBLIC KEY-----\n" .
				wordwrap($pubKey, 64, "\n", true) .
				"\n-----END PUBLIC KEY-----";
		}else {
			file_put_contents("d:/verify.txt", "2222222222\n", FILE_APPEND);
			//读取公钥文件
		...
		if ("RSA2" == $signType) {
			...
			file_put_contents("d:/verify.txt", "3333res = $res\n", FILE_APPEND);
		...
		file_put_contents("d:/verify.txt", "result = $result\n", FILE_APPEND);
		if($result == false)
		{
			file_put_contents("d:/verify.txt", "fuck you\n", FILE_APPEND);
		}
